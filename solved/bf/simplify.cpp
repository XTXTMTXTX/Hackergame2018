...
int main() {
	...
	for(int i=0;i<10;i++){
		scanf("%c",&tmp);
		innum[i]=BASEreftable[tmp];
	}
	for(int i=0;i<10;i++)
	for(int j=0;j<10;j++)ans[i]+=innum[j]*table[j*2][i+2]+innum[j]*table[j*2][1]*table[j*2+1][i+2];
	for(int i=0;i<10;i++)printf("%c",BASEtable[((ans[i]%256+256)%256)%64]);
}
